class HappyGallery {
  ...
  goToSlide(index, animate = true) {
    ...
    this.ui.querySelector("[data-hg-title]").innerHTML = title;
  ...
  getUIElement() {
    ...
    element.innerHTML = `
      <div class="hg-header">
        ...
        <a class="hg-share-icon" href="" title="">
        ...
        <a class="hg-share-icon" fill="currentcolor" href="" title="">
        ...
        <a href="" download class="hg-download hg-btn" data-hg-toolbar="download" >
          <svg xmlns="http://www.w3.org/2000/svg" class="hg-icon" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div class="hg-footer" data-hg-title></div>
    `;
  ...
  createStyleTag() {
    ...
    #happygallery-ui .hg-body .hg-body-images.hg-grabbing {
      cursor: grabbing;
    }
